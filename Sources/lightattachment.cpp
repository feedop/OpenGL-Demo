...
SpotLightAttachment::SpotLightAttachment(float relativeFront, float relativeRight, float relativeUp, SpotLight* spotLight, bool invertDirection) :
	LightAttachment(relativeFront, relativeRight, relativeUp), spotLight(spotLight), invertDirection(invertDirection) {}
...
bool SpotLightAttachment::getInvertDirection()
{
